...
{
	{ ACT_RANGE_ATTACK1,			ACT_RANGE_ATTACK_MP5,			true },
...
Activity CWeaponMP5::GetPrimaryAttackActivity( void )
{
	...
	DispatchParticleEffect( "weapon_mp5_muzzleflash", PATTACH_POINT_FOLLOW, pOwner->GetViewModel(), "muzzle", true);
